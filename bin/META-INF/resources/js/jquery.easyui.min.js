...
},beforePageText:"第",afterPageText:"页 共 {pages} 页",displayMsg:"第 {from} 至  {to} 项 共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["field","alias", "align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
if($(this).parent().attr("alias"))
_64f(_62a,$(this).parent().attr("alias"));
else
